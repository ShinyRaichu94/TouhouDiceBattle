...
if (CPUChoose == true){
	if (global.BoardFoM_GoldenYinYangSpaceChoose == 2) || ((global.BoardFoM_GoldenYinYangSpaceChoose == 1 || global.BoardFoM_GoldenYinYangSpaceChoose == 4) && global.MovementDiceChooseFinal == 4){
		DirectionSelect = 1;
	}
	alarm_set(1,60);
}