...
if (global.RoomCheck == "Room_DiceBattleSelect"){
	...
	global.Player1SeijaDice = true;
	global.Player2SeijaDice = true;
	global.Player3SeijaDice = true;
	global.Player4SeijaDice = true;
