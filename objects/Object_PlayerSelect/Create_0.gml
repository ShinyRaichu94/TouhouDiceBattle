...
if (global.RoomCheck == "Room_DiceBattleSelect"){
	...
	global.Player1TripleDice = true;
	global.Player2TripleDice = true;
	global.Player3TripleDice = true;
	global.Player4TripleDice = true;
