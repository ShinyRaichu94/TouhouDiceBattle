...
if (global.RoomCheck == "Room_DiceBattleSelect"){
	...
	global.Player1SlowDice = false;
	global.Player2SlowDice = false;
	global.Player3SlowDice = false;
	global.Player4SlowDice = false;
	global.Player1SeijaDice = false;
	global.Player2SeijaDice = false;
	global.Player3SeijaDice = false;
	global.Player4SeijaDice = false;
