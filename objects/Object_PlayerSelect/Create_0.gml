...
if (global.RoomCheck == "Room_DiceBattleSelect"){
	...
	global.Player1Blind = true;
	global.Player2Blind = true;
	global.Player3Blind = true;
	global.Player4Blind = true;
