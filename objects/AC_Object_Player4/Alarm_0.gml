...
if(variableself_handdirection == "left"){	/// @DnDAction : YoYo Games.Common.Execute_Code
	...
	/// @DnDHash : 119A232A
	/// @DnDParent : 7981DA61
	/// @DnDArgument : "code" "var playerchar = variable_global_get("Player"+global.Player4+"_Character");$(13_10)sprite_index = asset_get_index(playerchar+"_AirCutter_right");"
...
/// @DnDHash : 0E1A4E5E
	...
	/// @DnDHash : 44749852
	/// @DnDParent : 0E1A4E5E
	/// @DnDArgument : "code" "var playerchar = variable_global_get("Player"+global.Player4+"_Character");$(13_10)sprite_index = asset_get_index(playerchar+"_AirCutter_left");"
	var playerchar = variable_global_get("Player"+global.Player4+"_Character");
