...
(gamepad_is_connected(3) && gamepad_button_check_pressed(3, gp_face1) && PlayerController = "GP3"))
{
	...
	{
		global.PlayerC_Character = CharacterSelect;
		if(CharacterSelect == "Reimu"){with(Object_CharacterSelect_Reimu) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Marisa"){with(Object_CharacterSelect_Marisa) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Cirno"){with(Object_CharacterSelect_Cirno) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Sakuya"){with(Object_CharacterSelect_Sakuya) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Remilia"){with(Object_CharacterSelect_Remilia) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Alice"){with(Object_CharacterSelect_Alice) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Youmu"){with(Object_CharacterSelect_Youmu) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Suika"){with(Object_CharacterSelect_Suika) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Wriggle"){with(Object_CharacterSelect_Wriggle) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Reisen"){with(Object_CharacterSelect_Reisen) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Nitori"){with(Object_CharacterSelect_Nitori) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Sanae"){with(Object_CharacterSelect_Sanae) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Koishi"){with(Object_CharacterSelect_Koishi) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Futo"){with(Object_CharacterSelect_Futo) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		else if(CharacterSelect == "Tsukasa"){with(Object_CharacterSelect_Tsukasa) {instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerCSolid);}}
		instance_create_layer(x + 0, y + 0, "Cursor", Object_CharacterSelect_PlayerDCursor);
		instance_destroy();
	}
}
...
{
	instance_create_layer(x + 0, y + 0, "Solid", Object_CharacterSelect_PlayerBCursor);
	with(Object_CharacterSelect_PlayerBSolid) instance_destroy();
	instance_destroy();
}
