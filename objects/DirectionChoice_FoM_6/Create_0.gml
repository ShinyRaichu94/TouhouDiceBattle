...
if (CPUChoose == true){
	if (global.BoardFoM_GoldenYinYangSpaceChoose == 4) || ((global.BoardFoM_GoldenYinYangSpaceChoose == 2 || global.BoardFoM_GoldenYinYangSpaceChoose == 3 || global.BoardFoM_GoldenYinYangSpaceChoose == 6) && global.MovementDiceChooseFinal == 5){
		DirectionSelect = 1;
	}
	alarm_set(1,60);
}