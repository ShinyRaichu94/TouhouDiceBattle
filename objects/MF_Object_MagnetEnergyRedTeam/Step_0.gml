...
if (global.MinigameIntro == false && global.MinigameEnd == false){
	if (TeamPlayer1Control == true){
		...
		if (TeamPlayer1CPU_MashNow == true){
			...
			if (global.TeamRed2v2A == 1){var TeamPlayer1CPU = variable_global_get("Player"+global.Player1+"_CPULevel");}
			else if (global.TeamRed2v2A == 2){var TeamPlayer1CPU = variable_global_get("Player"+global.Player2+"_CPULevel");}
			else if (global.TeamRed2v2A == 3){var TeamPlayer1CPU = variable_global_get("Player"+global.Player3+"_CPULevel");}
			else if (global.TeamRed2v2A == 4){var TeamPlayer1CPU = variable_global_get("Player"+global.Player4+"_CPULevel");}
	...
	if (TeamPlayer2Control == true){
		...
		if (TeamPlayer2CPU_MashNow == true){
			...
			if (global.TeamRed2v2B == 1){var TeamPlayer2CPU = variable_global_get("Player"+global.Player1+"_CPULevel");}
			else if (global.TeamRed2v2B == 2){var TeamPlayer2CPU = variable_global_get("Player"+global.Player2+"_CPULevel");}
			else if (global.TeamRed2v2B == 3){var TeamPlayer2CPU = variable_global_get("Player"+global.Player3+"_CPULevel");}
			else if (global.TeamRed2v2B == 4){var TeamPlayer2CPU = variable_global_get("Player"+global.Player4+"_CPULevel");}
...
/*EnergyPower = ((((image_yscale / 40) / 10) + MF_Object_Token.RedTeamAd) / 4);
