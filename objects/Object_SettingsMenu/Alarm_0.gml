...
else if(variableself_setting == "BoardSelection")
{
	instance_create_layer(227, 256, "Instances", Object_BoardSelect_ForestOfMagic);
	instance_create_layer(533, 256, "Instances", Object_BoardSelect_GenbuRavine);
	instance_create_layer(833, 256, "Instances", Object_BoardSelect_RuinedWesternMansion);
	instance_create_layer(1139, 256, "Instances", Object_BoardSelect_ScarletDevilMansion);
	instance_create_layer(227, 512, "Instances", Object_BoardSelect_HumanVillage);
	instance_create_layer(533, 512, "Instances", Object_BoardSelect_AkiFarm);
	instance_create_layer(833, 512, "Instances", Object_BoardSelect_ShiningNeedleCastle);
	instance_create_layer(1139, 512, "Instances", Object_BoardSelect_YukarisGapStation);
	instance_create_layer(227, 256, "Cursor", Object_BoardSelect_Cursor);
}
