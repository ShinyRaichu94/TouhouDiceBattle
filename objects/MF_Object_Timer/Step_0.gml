...
if(global.MinigameTimer <= 0){	/// @DnDAction : YoYo Games.Common.If_Variable
	...
	if(MinigameResultCheck == false){	/// @DnDAction : YoYo Games.Common.Set_Global
		...
		/// @DnDVersion : 1
		/// @DnDHash : 58AE0B5E
		/// @DnDApplyTo : {MF_Object_MagnetEnergyBlueTeam}
		/// @DnDParent : 56EA4E90
		with(MF_Object_MagnetEnergyBlueTeam) instance_destroy();
	
		/// @DnDAction : YoYo Games.Instances.Destroy_Instance
		/// @DnDVersion : 1
		/// @DnDHash : 7365D2F4
		/// @DnDApplyTo : MF_Object_MagnetEnergyRedTeam
		/// @DnDParent : 56EA4E90
		with(MF_Object_MagnetEnergyRedTeam) instance_destroy();
