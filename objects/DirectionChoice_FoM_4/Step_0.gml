			...
			if (global.PlayerTurn == 1){
				if (DirectionSelect == 1){
					with(Object_BoardPlayer1){
						PathVariable = Path_Board_FoM_14;
						path_start(Path_Board_FoM_14, path_speed, path_action_stop, true);
						path_position = 0;
					}
				}
				else{
					with(Object_BoardPlayer1){
						PathVariable = Path_Board_FoM_7;
						path_start(Path_Board_FoM_7, path_speed, path_action_stop, true);
						path_position = 0;
					}
				}
			}
