...
if (CPUChoose == true){
	if (global.BoardFoM_GoldenYinYangSpaceChoose == 5) || (global.BoardFoM_GoldenYinYangSpaceChoose == 6) || ((global.BoardFoM_GoldenYinYangSpaceChoose == 1 || global.BoardFoM_GoldenYinYangSpaceChoose == 2) && global.MovementDiceChooseFinal != 8){
		DirectionSelect = 1;
	}
	alarm_set(1,60);
}