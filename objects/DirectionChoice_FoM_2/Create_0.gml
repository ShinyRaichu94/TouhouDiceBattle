...
if (CPUChoose == true){
	if (global.BoardFoM_GoldenYinYangSpaceChoose == 1 && global.MovementDiceChooseFinal != 8) || (global.BoardFoM_GoldenYinYangSpaceChoose == 4 && global.MovementDiceChooseFinal != 8) || (global.BoardFoM_GoldenYinYangSpaceChoose == 5) || (global.BoardFoM_GoldenYinYangSpaceChoose == 6) || (global.BoardFoM_GoldenYinYangSpaceChoose == 3 && global.MovementDiceChooseFinal == 4){
		DirectionSelect = 1;
	}
	alarm_set(1,60);
}