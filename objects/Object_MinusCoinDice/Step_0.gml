randomize();
if(variableself_dicestop == false){global.CoinSpaceValueSet = floor(random_range(10, 250 + 1));}
if(variableself_dicestop == false){
	if(global.CoinSpaceValue <= 49)
	{
		sprite_index = Sprite_MinusCoinDice1;
		image_index = 0;
	}
	else if(global.CoinSpaceValue <= 99)
	{
		sprite_index = Sprite_MinusCoinDice2;
		image_index = 0;
	}
	else if(global.CoinSpaceValue <= 149)
	{
		sprite_index = Sprite_MinusCoinDice3;
		image_index = 0;
	}
	else if(global.CoinSpaceValue <= 199)
	{
		sprite_index = Sprite_MinusCoinDice4;
		image_index = 0;
	}
	else
	{
		sprite_index = Sprite_MinusCoinDice5;
		image_index = 0;
	}
}
else{
	if(global.CoinSpaceValueFinal <= 49)
	{
		sprite_index = Sprite_MinusCoinDice1;
		image_index = 0;
	}
	else if(global.CoinSpaceValueFinal <= 99)
	{
		sprite_index = Sprite_MinusCoinDice2;
		image_index = 0;
	}
	else if(global.CoinSpaceValueFinal <= 149)
	{
		sprite_index = Sprite_MinusCoinDice3;
		image_index = 0;
	}
	else if(global.CoinSpaceValueFinal <= 199)
	{
		sprite_index = Sprite_MinusCoinDice4;
		image_index = 0;
	}
