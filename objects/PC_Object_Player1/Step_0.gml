...
var l07917182_0 = false;l07917182_0 = instance_exists(PC_Object_Controller);if(l07917182_0){	/// @DnDAction : YoYo Games.Common.Execute_Code
	...
	else
	{
		...
		if (PlayerCPU = "Easy")
		{
			...
			var RandomRange = random_range(0,250);
		}
		else if (PlayerCPU = "Normal")
		{
			var PlayerCPURange = 64;
			var RandomRange = random_range(0,500);
		}
		else if (PlayerCPU = "Hard")
		{
			var PlayerCPURange = 48;
			var RandomRange = random_range(0,750);
		}
		else if (PlayerCPU = "Lunatic")
		{
			var PlayerCPURange = 32;
			var RandomRange = random_range(0,1000);
		}
		
		var RandomMaxTime = random_range(20,120);
		...
		if (distance_to_object(instance_nearest(x,y,PC_Object_CoinMask)) <= RandomRange)
		{
			if (CPUCoinTarget = 0)
			{
				...
				with(PC_Object_Player4) if (CPUCoinTarget == CPUCoinTarget)
				{
					CPUCoinTarget = 0;
				}
			}
