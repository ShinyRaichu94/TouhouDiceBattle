...
/// @DnDHash : 7363BF00
/// @DnDArgument : "var" "global.MinigameSelect"
/// @DnDArgument : "value" ""Keystone Courage""
if(global.MinigameSelect == "Keystone Courage"){	/// @DnDAction : YoYo Games.Drawing.Draw_Value
	...
	/// @DnDArgument : "x" "683"
	/// @DnDArgument : "y" "460"
	/// @DnDArgument : "caption" ""Push the button to stop the Keystone before it lands on you and crushes you. Who ever stops it the closest wins.""
	...
	/// @DnDArgument : "x" "683"
	/// @DnDArgument : "y" "600"
	/// @DnDArgument : "caption" ""Press the Z key on your keyboard or the bottom button on your controller to stop the Keystone.""
...
if(global.MinigameSelect == "Pachin-Coin"){	/// @DnDAction : YoYo Games.Drawing.Draw_Value
	...
	/// @DnDArgument : "x" "683"
	/// @DnDArgument : "y" "460"
	/// @DnDArgument : "caption" ""Fairies are dropping coins in the pachinko machine. Collect as many coins as you can. You can keep the coins you've collected.""
	...
	/// @DnDArgument : "x" "683"
	/// @DnDArgument : "y" "480"
	/// @DnDArgument : "caption" ""Bronze Coins are worth 10 Coins, Silver Coins are worth 25 Coins, and Gold Coins are worth 50 Coins.""
	draw_text(683, 480, string("Bronze Coins are worth 10 Coins, Silver Coins are worth 25 Coins, and Gold Coins are worth 50 Coins.") + "");
	...
	/// @DnDArgument : "x" "683"
	/// @DnDArgument : "y" "600"
	/// @DnDArgument : "caption" ""Use the arrow keys on your keyboard or the left joystick on your controller to move left or right.""
